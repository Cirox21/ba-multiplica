...
function loadMusic(indexNumb){
  ...
  musicImg.src = `../Image/esquivando-charcos.png`;
...
//función de cancion anterior
function prevMusic(){
  musicIndex--; //disminución de musicIndex en 1
...
//función de cancion proxima
function nextMusic(){
  musicIndex++; //incremento de musicIndex en 1
  //si musicIndex es mayor que la longitud de la matriz, entonces musicIndex será 1, por lo que se reproducirá la primera música
...
playPauseBtn.addEventListener("click", ()=>{
  ...
  //si isPlayMusic es verdadero, llame a pauseMusic; de lo contrario, llame a playMusic
  isMusicPlay ? pauseMusic() : playMusic();
  playingSong();
});

//evento botón de cancion anterior
prevBtn.addEventListener("click", ()=>{
  prevMusic();
});

//evento botón de cancion proxima
...
mainAudio.addEventListener("timeupdate", (e)=>{
  const currentTime = e.target.currentTime; //reproduciendo la canción horaActual
